...
- Four applications: Nian, RALLO, Phenolab and Pulse; each explains capture, understanding, action and current maturity.
...
- RALLO uses an existing prototype screenshot. Phenolab currently uses a clearly labelled, existing Designer preview. Hardware and workshop concepts are labelled. No quantified accuracy or autonomous-lab capability is asserted.
