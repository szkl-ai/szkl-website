...
export const products=[
 ...
 action:tx('Coordinate lab work, review outcomes and carry what was learned into the next experiment. AI recommendations remain subject to scientific review.','协调实验任务、复核结果，将本轮发现带入下一次实验；AI 建议由研究人员审核。'),
 stage:tx('Phenolab is available at lab.szkl.com with organization sign-in. Camera capture and next-experiment recommendations are development directions; the platform does not imply autonomous laboratory control.','Phenolab 已部署于 lab.szkl.com，需使用组织账号登录。相机采集与下一轮实验建议是开发方向，并不代表已实现实验室自主控制。'),
